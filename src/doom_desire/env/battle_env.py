...
class BattleEnv(Env, ABC):  # pyre-ignore
    ...
    def train_player(self,
                     player_1: Player,
                     player_2: Player,
                     env_algorithm: Callable, env_algorithm_kwargs=None,
                     *,
                     train_player_2: Optional[bool] = False):
        pass
    ...
    def play_against(
        ...
        async def launch_battles(player_1: Player, player_2: Player):
